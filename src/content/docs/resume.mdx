...
- EFTPOS: Hypercom, Ingenico
- Programming: C/C++ Language, Java
- Framework: Spring Boot, JPOS
- Message Broker: Kafka
- HSM: Thales PayShield, SafeNet LunaEFT
- Financial Messaging; ISO8583, XML, JSON
- Smartcard APDU: ISO7816, ISO14443 A/B
- PCI DSS
- Camel, Postman